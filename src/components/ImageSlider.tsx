      ...
      <div className="absolute z-10 inset-0 opacity-0 group-hover:opacity-100 transition">
        ...
        <button 
          className={cn(activeStyle, "right-3 transition", { 
            ...
            "hover:bg-blue-300 text-blue-800 opacity-100": !slideConfig.isEnd,
          })} 
        ...
        <button 
          className={cn(activeStyle, "left-3 transition", { 
            ...
            "hover:bg-blue-300 text-blue-800 opacity-100": !slideConfig.isBeginning,
          })}
          onClick={(e) => {
            e.preventDefault();
        ...
        {urls.map((item) => {
          return (
            <SwiperSlide key={item}>
              <div className="flex justify-center items-center h-[200px] bg-red-300">
                Slide {item}
              </div>
            </SwiperSlide>
          );
